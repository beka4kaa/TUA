...
export const translations = {
  en: {
    ...
    results: {
      ...
      cards: {
        ...
        quotes: [
          {
            id: "quote-sarah",
            quote: "Ymit Academy transformed my application journey. Their strategic guidance helped me secure admission to my dream school with a full scholarship.",
            author: "Sarah Chen",
            school: "Harvard University '24",
          },
          {
            id: "quote-alex",
            quote: "I was rejected from every school I applied to on my own. With Ymit, I got into Stanford, MIT, and Cornell — and chose where I actually wanted to go.",
            author: "Alex Petrov",
    ...
    reviews: {
      heading: "REVIEWS",
      quote: "Ymit Academy transformed my application journey. Their strategic guidance helped me secure admission to my dream school with a full scholarship. The personalized attention made all the difference.",
      author: "Sarah Chen",
      school: "Harvard University '24",
    },
  ...
  ru: {
    ...
    results: {
      ...
      cards: {
        ...
        quotes: [
          {
            id: "quote-sarah",
            quote: "Ymit Academy изменила мой путь к поступлению. Их стратегическое руководство помогло мне поступить в университет мечты с полной стипендией.",
            author: "Sarah Chen",
            school: "Harvard University '24",
          },
          {
            id: "quote-alex",
            quote: "Самостоятельно меня отклонили везде. С Ymit я поступил в Stanford, MIT и Cornell — и выбрал тот университет, который действительно хотел.",
            author: "Alex Petrov",
            school: "Stanford University '25",
          },
          {
    ...
    reviews: {
      heading: "ОТЗЫВЫ",
      quote: "Ymit Academy изменила мой путь к поступлению. Их стратегическое руководство помогло мне поступить в университет мечты с полной стипендией. Индивидуальный подход решил всё.",
      author: "Sarah Chen",
      school: "Harvard University '24",
    },
