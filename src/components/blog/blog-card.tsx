        ...
        >
          {post.coverImageUrl ? (
            ...
            <div className="absolute inset-0 bg-linear-to-br from-gray-50 via-gray-100 to-gray-50">
              ...
              {/* Accent line */}
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-[#1B5FAA] via-[#1B5FAA] to-[#1B5FAA] opacity-20" />
            </div>
          )}
        ...
        <div className="p-5 md:p-6">
          ...
          <h3
            className={cn(
              ...
              "group-hover:text-[#1B5FAA] transition-colors duration-300",
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            <span className="text-sm font-medium text-gray-900 group-hover:text-[#1B5FAA] transition-colors flex items-center gap-1">
              Read more
