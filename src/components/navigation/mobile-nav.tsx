            ...
            {session ? (
              ...
              <>
                <Link
                  href="/signup"
                  onClick={handleLinkClick}
                  className="flex items-center justify-center w-full px-6 py-3.5 bg-[#1B5FAA] text-white font-body text-sm font-medium rounded-full hover:shadow-lg hover:shadow-[#1B5FAA]/20 transition-all"
                >
                  Get Started
                  <ArrowUpRight className="w-4 h-4 ml-2" />
                </Link>
