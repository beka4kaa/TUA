...
const primaryLinks = [
  ...
  { label: "Career", href: "#career", badge: "HOT" },
...
const groupedSections = [
  {
    ...
    superscript: "16",
    links: [
      { label: "Harvard", href: "#results" },
      { label: "Stanford", href: "#results" },
      { label: "MIT", href: "#results" },
      { label: "Oxford", href: "#results" },
      { label: "Cambridge", href: "#results" },
      { label: "Yale", href: "#results" },
      { label: "...", href: "#results" },
    ],
  },
  {
    title: "Services",
    links: [
      { label: "University Shortlist", href: "#services" },
  ...
  },
  {
    ...
    links: [
      { label: "USA & Canada", href: "#expertise" },
      { label: "United Kingdom", href: "#expertise" },
      { label: "Europe", href: "#expertise" },
      { label: "Asia & Australia", href: "#expertise" },
      { label: "Scholarships", href: "#expertise" },
      { label: "STEM Programs", href: "#expertise" },
    ],
  },
  {
    title: "Our Stack",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-12 xl:gap-20">
                ...
                >
                  {groupedSections.map((section, sectionIndex) => (
                    ...
                    >
                      {/* Section heading */}
                      <h3 className="text-xl md:text-2xl font-semibold text-[#111] tracking-tight flex items-start gap-1">
                        {section.title}
                        {section.superscript && (
                          <sup className="text-[10px] text-[#999] font-normal">{section.superscript}</sup>
                        )}
                      </h3>
              ...
              <div className="border border-[#E0E0E0] rounded-xl overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-[#E0E0E0]">
                  ...
                  <div className="px-6 py-5 flex items-center gap-3">
                    ...
                    <a href="#" className="w-9 h-9 rounded-full border-2 border-yellow-400 flex items-center justify-center text-[#111] hover:bg-yellow-400 transition-colors">
