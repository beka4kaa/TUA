              ...
              <div className="border border-[#E0E0E0] dark:border-[#2a2a2a] rounded-xl overflow-hidden">
                ...
                {/* Info row */}
                  ...
                  <div className="px-6 py-5 flex items-center gap-3">
                    ...
                    <a href="#" className="w-9 h-9 rounded-full border-2 border-[#1B5FAA] flex items-center justify-center text-[#1B5FAA] hover:bg-[#1B5FAA] hover:text-white transition-colors">
