 ...
 * Individual SVG icons for proper display and accessibility
 */
...
export function LinkedInIcon({ className, size = 20 }: SocialIconProps) {
  return (
    <svg 
      className={className}
      width={size} 
...
export function TwitterIcon({ className, size = 20 }: SocialIconProps) {
  return (
    <svg 
      className={className}
      width={size} 
