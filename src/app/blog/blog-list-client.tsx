  ...
  return (
    <div className="relative">
      ...
      >
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#1B5FAA] transition-colors mb-8"
        >
      ...
      {posts.length === 0 ? (
        ...
        >
          <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#1B5FAA]/10 flex items-center justify-center">
            <svg className="w-8 h-8 text-[#1B5FAA]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {activeTag && (
            <button
              ...
              className="px-6 py-2 bg-[#1B5FAA] text-white rounded-full hover:bg-[#1B5FAA]/90 transition-colors"
            >
              Показать все статьи
            </button>
          )}
