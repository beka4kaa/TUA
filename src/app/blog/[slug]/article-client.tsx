      ...
      <section className="relative py-12 md:py-20">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            {/* Markdown content */}
            <div className="prose prose-lg prose-gray max-w-none prose-headings:font-display prose-headings:text-[#111111] prose-a:text-[#1B5FAA] prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl prose-pre:bg-gray-900 prose-code:text-[#1B5FAA]">
