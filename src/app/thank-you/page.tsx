    ...
    <div className="relative min-h-screen bg-white overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <span className="w-2 h-2 bg-[#1B5FAA] rounded-full" />
          <span className="w-12 h-0.5 bg-gray-200 rounded-full" />
        </motion.div>
          ...
          <ul className="text-left space-y-3 text-gray-600">
            {[
              ...
              <li key={index} className="flex items-start">
                <span className="w-6 h-6 rounded-full bg-[#1B5FAA]/10 flex items-center justify-center mr-3 shrink-0 mt-0.5">
                  <span className="text-sm font-medium text-[#1B5FAA]">
                    {index + 1}
                  </span>
                </span>
                {item}
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center justify-center h-12 px-8 bg-[#1B5FAA] hover:bg-[#164C88] text-white font-medium rounded-lg transition-all duration-300 shadow-lg shadow-[#1B5FAA]/20 hover:shadow-xl hover:shadow-[#1B5FAA]/30 hover:-translate-y-0.5"
          >
            <svg
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center h-12 px-8 bg-white border border-gray-200 hover:border-[#1B5FAA] text-gray-700 hover:text-[#1B5FAA] font-medium rounded-lg transition-all duration-300"
          >
            <svg
              className="w-5 h-5 mr-2"
              fill="none"
